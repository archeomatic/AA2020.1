...
# 5b - Ajustement d'un modéle (fit) de variogramme (fonction vgm) / Ici, psill et range sont donnés Ã  tritre indicatif
...
## Créer un grid vide (limite de la fenÃªtre) = attention Ã  la taille de la cellule en sortie, demande qq minutes pour kriger!
ouest<-474242.855888
est<-476935.196567
nord<-267752.513007
sud<-266551.203890
...
# 7 - validation croisée = pour valider le modÃ¨le
