...
# anis = c(angle principal, minor range/major range) DONC ici, anis = c(70, 200/300), avec 200 m pour 160° et 300 m pour 70°)
...
### calcul coefficient de corrélation entre 2 variables (cor)
